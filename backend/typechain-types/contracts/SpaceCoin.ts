...
export interface SpaceCoinInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "isTrasferTaxActive",
    values?: undefined
  ): string;
...
export interface SpaceCoin extends BaseContract {
  ...
  functions: {
    ...
    isTrasferTaxActive(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    isTrasferTaxActive(overrides?: CallOverrides): Promise<BigNumber>;
